...
class ForecastContractTest(unittest.TestCase):
    ...
    def test_evaluation_contract_copies_nested_metrics_immutably(self):
        ...
        evaluation = ForecastEvaluation(
            ...
            always_up_direction_accuracy=np.float64(0.55),
            balanced_accuracy=np.float64(0.58),
            macro_f1=np.float64(0.57),
            non_overlapping_sample_count=np.int64(8),
            non_overlapping_direction_accuracy=np.float64(0.625),
        ...
        self.assertEqual(
            evaluation.to_dict(),
            {
                ...
                "zero_return_mae": 0.05,
                "historical_mean_mae": 0.045,
                "always_up_direction_accuracy": 0.55,
                "balanced_accuracy": 0.58,
                "macro_f1": 0.57,
                "non_overlapping_sample_count": 8,
                "non_overlapping_direction_accuracy": 0.625,
                "evidence_status": "unproven",
                "rank_ic": None,
